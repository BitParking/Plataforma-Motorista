    ...
    run(inputs, options) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (options['livereload']) {
                const { serve } = yield Promise.resolve().then(() => require('@ionic/cli-utils/lib/serve'));
                // TODO: use runner directly
                const details = yield serve({ config: this.env.config, log: this.env.log, prompt: this.env.prompt, shell: this.env.shell, project: this.project }, inputs, utils_1.generateBuildOptions(metadata, inputs, options));
                ...
                log.setFormatter(cli_framework_1.createPrefixedFormatter(`${chalk_1.default.dim(`[cordova]`)} `));
                const ws = log.createWriteStream(cli_framework_1.LOGGER_LEVELS.INFO);
                yield this.runCordova(utils_1.filterArgumentsForCordova(metadata, options), { stream: ws });
