    ...
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        try {
            const [port, livereloadPort, notificationPort] = yield Promise.all([
                network_1.findClosestOpenPort(ports.port, '0.0.0.0'),
                network_1.findClosestOpenPort(ports.livereloadPort, '0.0.0.0'),
                network_1.findClosestOpenPort(ports.notificationPort, '0.0.0.0'),
            ]);
            if (ports.port !== port) {
