    ...
    serveCommandWrapper(options) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const requiredMsg = `This package is required for ${chalk_1.default.green('ionic serve')}. For more details, please see the CHANGELOG: ${chalk_1.default.bold('https://github.com/ionic-team/ionic-cli/blob/master/packages/ionic/CHANGELOG.md#4.0.0')}`;
                this.e.log.nl();
                this.e.log.info(`Looks like ${chalk_1.default.green(pkg)} isn't installed in this project.\n` + requiredMsg);
                const installed = yield this.promptToInstallPkg({ pkg, saveDev: true });
                if (!installed) {
                    this.e.log.nl();
    ...
    servecmd(options) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            return new Promise((resolve, reject) => {
                ...
                log.setFormatter(cli_framework_1.createPrefixedFormatter(chalk_1.default.dim(`[${program === DEFAULT_PROGRAM ? 'v1' : program}]`)));
